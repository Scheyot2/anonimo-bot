const menuartes = (pr,nomeDono,NomeDoBot) => {
    return `
...
module.exports.menuartes = menuartes 


const símbolosnick = (pr,nomeDono,NomeDoBot) => {
    return ` 
  ╭━━━━━•✠•⊰━━━━━
╿║➥ⒶⒷⒸⒹⒺⒻⒼⒽ
╿║➥ⒾⒿⓀⓁⓂⓃⓄⓅⓆⓇⓈⓉⓊⓋⓌⓍⓎⓏⓐⓑⓒⓓⓔ
...
╿║➥℃ᗪďᗴℇℰΣΞ℮ℯєᖴ℉ǤᏳĜǤ
╿║➥ℊᕼℋℎℏℌђÏᎥᒎℑᛕᒪℒⱢℓŁℓ
╿║➥ŁᗰᑎＮηᗝ۝ℴᑭƤ℘Ɋᖇℛℜ℞℟яᔕŞšƬᑌᙈ℧ᐯ℣ᗯѾω᙭x╳ﾒ×ƳŸƔƵ
╿║➥︼∉∌⩻⩼⪨⪩⁅⁆⋉⋊⧼⧽⦃⦄⦅⦆⦇⦈⦉⦊【】꧁꧂
╿║➥𓆩𓆪𒈞─━→⇝𒆜ღლتツッヅ㋡〄ᬊᬁᬊ᭄❝❞❛❜┃
║┊┇↑↓↺↻☞☜›‹〔〕►▶
╿║➥◕✆✇▬✉︎✍︎✎✐✑✓✔࿅ꗃ➠➺➼↠➶
...
module.exports.símbolosnick = símbolosnick 

const artes = (pr,nomeDono,NomeDoBot) => {
    return ` 
╭━━━━━━━✠•⊰━━━━
╭━┳━╭━╭━╮╮
┃┈┈┈┣▅╋▅┫┃
...
module.exports.artes = artes 
const artes1 = (pr,nomeDono,NomeDoBot) => {
    return ` 
 ╭━━━━━•✠•⊰━━━━━
...
module.exports.artes1 = artes1 

const artes2 = (pr,nomeDono,NomeDoBot) => {
    return ` 
╭━━━━━━•✠•⊰━━━━
...
module.exports.artes2 = artes2 

const artes3 = (pr,nomeDono,NomeDoBot) => {
    return `
╭━━━━━⊱•✠•⊰━━━━
...
module.exports.artes3 = artes3
const letras = (pr,nomeDono,NomeDoBot) => {
    return `  
 by: 𝕒𝕟𝕟ô𝕟𝕚𝕞𝕠 
